...
## Описание
Приложение, представляващо система за откриване на аномалии, пригодена за автомобилната индустрия. Системата анализира данни от различни сензори в двигателя на колата, използвайки усъвършенствани техники за статистическо моделиране.
